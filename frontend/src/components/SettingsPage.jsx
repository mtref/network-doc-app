...
// UPDATED: Corrected the API endpoint for PDF uploads.
...
// ... (CollapsibleSection component remains the same) ...
...
function SettingsPage({ showMessage }) {
  ...
  const handlePdfUpload = async (event) => {
    ...
    formData.append('file', file);
    try {
      // CORRECTED: Use the '/pdf_templates' endpoint for POST
      await api('pdf_templates', {
        method: 'POST',
        body: formData,
      });
