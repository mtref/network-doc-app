...
import { RefreshCw, Filter, XCircle, ArrowRight, Eye } from "lucide-react";
    ...
    <section className="p-5 bg-gray-50 rounded-lg border border-gray-200 shadow-inner">
      ...
      <div className="flex flex-wrap gap-4 mb-4 p-4 bg-white rounded-md border">
        ...
        <button
          onClick={fetchLogs}
          disabled={loading}
          className="p-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 disabled:bg-blue-300 flex items-center"
        >
          <RefreshCw
            size={16}
      ...
      <div className="flex justify-between items-center mt-4 text-sm">
        <span>
          Page {pagination.current_page} of {pagination.pages} (Total:{" "}
